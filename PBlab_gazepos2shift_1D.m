...
for i = 1:size(data.gaze_raw,1)
    ...
    for t = usabletimevec;  % loop over all usable time points, taking into account tat we need a window before and after threshold crossings to extract shift size;         
